...
import com.devdroid.a7minutesworkout.databinding.ActivityBmiBinding
    ...
    private fun calculateUnits(){
        if(currentVisibleView == METRIC_UNITS_VIEW){
            ...
            if(validateUsUnits()){
                ...
                val usHeight: Float = usUnitHeightValueInch.toFloat() + 12 * usUnitHeightValueFeet.toFloat()
                val bmi = 703 * (usUnitWeightValue / (usHeight * usHeight))
                displayBMIResult(bmi)
            }else{
                Toast.makeText(this@BMIActivity,"please enter valid value",Toast.LENGTH_SHORT).show()
            }
